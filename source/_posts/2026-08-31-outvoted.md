...
![The same relevant token holding steady against 200 off-topic tokens, then splitting its share three ways against near-duplicates of itself](/images/outvoted/dilution-bars.svg)
...
![Right after "drop it", the retraction is loud and the approach fades; a few turns later the retraction has faded out while the approach still holds actual lines to write](/images/outvoted/chamber-3-abandoned-bars.svg)
